...
begin
    ...
    for i in 1..days
        loop
            ...
            update indexed_lanternfish
            set fishies = fishies + coalesce((select fishies from indexed_lanternfish where age = - 1), 0)
            where age = 6;
            insert into indexed_lanternfish
            select fishies, 6
            from indexed_lanternfish
            where age = -1
